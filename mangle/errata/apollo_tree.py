#!/usr/bin/env python3
# Slightly modified version of tool in: https://github.com/resf/distro-tools/
# This modification gets around the reliance on the apollo library, since
# all that we need is a dict.
